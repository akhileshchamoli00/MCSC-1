...
export function Header() {
  ...
  const ipItems = [
    { label: t.nav.brandClassification, href: "/intellectual-property/brand-classification" },
    { label: t.nav.checkApplicationStatus, href: "/intellectual-property/check-application-status" },
  ]
        ...
        <nav className="hidden items-center gap-1 md:flex">
          ...
          >
            <Link
              ...
              className={`group relative flex items-center gap-1 px-5 py-2 text-[14px] font-semibold tracking-wide transition-colors duration-300 ${pathname.startsWith("/intellectual-property") ? "text-foreground" : "text-muted-foreground hover:text-foreground"
                }`}
            >
              ...
              />
              <span
                className={`absolute bottom-0 left-0 h-0.5 bg-primary transition-all duration-300 ${pathname.startsWith("/intellectual-property") ? "w-full" : "w-0 group-hover:w-full"
                  }`}
              />
            </Link>
          ...
          <nav className="container mx-auto flex flex-col gap-1 px-4 py-6">
            ...
            <div className="flex flex-col">
              <button
                ...
                className={`flex items-center justify-between rounded-lg px-4 py-3 text-sm font-medium transition-colors ${pathname.startsWith("/intellectual-property")
                  ? "bg-muted text-foreground"
                  : "text-muted-foreground hover:bg-muted/50 hover:text-foreground"
                  }`}
              >
