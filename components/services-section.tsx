...
import { Building2, FileText, RefreshCw, Scale, MapPin, Users, Lightbulb, ChevronLeft, ChevronRight } from "lucide-react"
...
export function ServicesSection() {
  ...
  return (
    <section id="services" className="pt-12 pb-12 md:pt-16 md:pb-16 overflow-hidden">
                        ...
                        >
                          ...
                          >
                            <CardHeader className="space-y-4">
                              ...
                              <CardTitle className="text-2xl font-bold text-card-foreground line-clamp-2">{service.title}</CardTitle>
                            </CardHeader>
                            <CardContent className="flex-grow flex flex-col justify-between">
                              <CardDescription className="text-base leading-relaxed line-clamp-4 mb-6">{service.description}</CardDescription>
                              <span className="text-primary font-semibold flex items-center gap-1 group/btn mt-auto">
                                {language === "en" ? "Learn More" : "Pelajari Selengkapnya"}
