            ...
            <CardHeader className="pt-12 pb-8 px-8 md:px-12 border-b border-primary/10">
              <div className="flex items-center gap-6">
                ...
                <div>
                  ...
                  <p className="text-lg text-primary/80 font-medium">{service.description}</p>
                </div>
              </div>
            </CardHeader>
            <CardContent className="py-12 px-8 md:px-12">
              ...
              <div className="mt-16 grid gap-6 md:grid-cols-2">
                <div className="p-6 rounded-xl bg-primary/5 border border-primary/10">
                  <h4 className="font-bold mb-2 text-primary">
                    {language === "en" ? "Expert Consultation" : (language === "cn" ? "专家咨询" : "Konsultasi Ahli")}
                  </h4>
                  <p className="text-sm text-muted-foreground">
                    {language === "en"
                      ? "Get professional guidance tailored to your specific business needs."
                      : (language === "cn" ? "获得针对您特定业务需求定制的专业指导。" : "Dapatkan panduan profesional yang disesuaikan dengan kebutuhan bisnis spesifik Anda.")}
                  </p>
                </div>
                <div className="p-6 rounded-xl bg-primary/5 border border-primary/10">
                  <h4 className="font-bold mb-2 text-primary">
                    {language === "en" ? "Full Compliance" : (language === "cn" ? "完全合规" : "Kepatuhan Penuh")}
                  </h4>
                  <p className="text-sm text-muted-foreground">
                    {language === "en"
                      ? "Ensuring all your corporate documentation meets current regulations."
                      : (language === "cn" ? "确保您的所有公司文件符合现行法规。" : "Memastikan semua dokumentasi perusahaan Anda memenuhi peraturan saat ini.")}
                  </p>
                </div>
              </div>
              ...
              <div className="mt-12 flex justify-center">
                <Button
                  ...
                  onClick={() => window.open('https://wa.me/628128000000', '_blank')}
                >
                  {language === "en" ? "Inquire Now" : (language === "cn" ? "立即咨询" : "Hubungi Kami")}
