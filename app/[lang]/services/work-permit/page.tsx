...
export async function generateMetadata(props: PageProps): Promise<Metadata> {
  ...
  return {
    ...
    alternates: {
      canonical: `https://www.mcsc.co.id/${lang}/services/work-permit`,
      languages: {
...
export default async function WorkPermitPage(props: PageProps) {
  const params = await props.params;
      ...
      <div className="container mx-auto px-4 pt-8 pb-0 max-w-6xl text-left">
        ...
        <section id="permit-needed" className="scroll-mt-24 mb-16">
          <h2 className="text-3xl font-bold mb-6 text-foreground border-b border-border/50 dark:border-white/10 pb-3">
            {getTranslation(contentData.permitTitle)}
          </h2>
          <p className="text-base text-muted-foreground leading-relaxed mb-6">
            {getTranslation(contentData.permitDesc)}
          </p>
          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3 mb-8">
            ...
            <div className="p-6 rounded-2xl border border-border/50 dark:border-white/15 bg-background/45 hover:border-primary/40 hover:bg-primary/5 transition-all duration-300 backdrop-blur-sm shadow-sm group">
              <h3 className="font-bold text-foreground group-hover:text-primary transition-colors text-lg mb-3 pb-1.5 border-b border-border/10">
                {getTranslation(contentData.reqKitasTitle)}
              </h3>
              <p className="text-xs md:text-sm text-muted-foreground leading-relaxed">
                {getTranslation(contentData.reqKitasDesc)}
              </p>
            </div>
            ...
            <div className="p-6 rounded-2xl border border-border/50 dark:border-white/15 bg-background/45 hover:border-primary/40 hover:bg-primary/5 transition-all duration-300 backdrop-blur-sm shadow-sm group">
              <h3 className="font-bold text-foreground group-hover:text-primary transition-colors text-lg mb-3 pb-1.5 border-b border-border/10">
                {getTranslation(contentData.reqKitapTitle)}
              </h3>
              <p className="text-xs md:text-sm text-muted-foreground leading-relaxed">
                {getTranslation(contentData.reqKitapDesc)}
              </p>
            </div>
            ...
            <div className="p-6 rounded-2xl border border-border/50 dark:border-white/15 bg-background/45 hover:border-primary/40 hover:bg-primary/5 transition-all duration-300 backdrop-blur-sm shadow-sm group">
              <h3 className="font-bold text-foreground group-hover:text-primary transition-colors text-lg mb-3 pb-1.5 border-b border-border/10">
                {getTranslation(contentData.reqClosureTitle)}
              </h3>
              <p className="text-xs md:text-sm text-muted-foreground leading-relaxed">
                {getTranslation(contentData.reqClosureDesc)}
              </p>
            </div>
            ...
            <div className="p-6 rounded-2xl border border-border/50 dark:border-white/15 bg-background/45 hover:border-primary/40 hover:bg-primary/5 transition-all duration-300 backdrop-blur-sm shadow-sm group">
              <h3 className="font-bold text-foreground group-hover:text-primary transition-colors text-lg mb-3 pb-1.5 border-b border-border/10">
                {getTranslation(contentData.reqBusinessTitle)}
              </h3>
              <p className="text-xs md:text-sm text-muted-foreground leading-relaxed">
                {getTranslation(contentData.reqBusinessDesc)}
              </p>
            </div>
            ...
            <div className="p-6 rounded-2xl border border-border/50 dark:border-white/15 bg-background/45 hover:border-primary/40 hover:bg-primary/5 transition-all duration-300 backdrop-blur-sm shadow-sm group">
              <h3 className="font-bold text-foreground group-hover:text-primary transition-colors text-lg mb-3 pb-1.5 border-b border-border/10">
                {getTranslation(contentData.reqCertificateTitle)}
              </h3>
              <p className="text-xs md:text-sm text-muted-foreground leading-relaxed">
                {getTranslation(contentData.reqCertificateDesc)}
              </p>
            </div>
          </div>
