...
export async function generateMetadata(props: PageProps): Promise<Metadata> {
  ...
  return {
    ...
    alternates: {
      canonical: `https://www.mcsc.co.id/${lang}/services/intellectual-property`,
      languages: {
        "en": `https://www.mcsc.co.id/en/services/intellectual-property`,
        "id": `https://www.mcsc.co.id/id/services/intellectual-property`,
        "zh": `https://www.mcsc.co.id/cn/services/intellectual-property`,
...
export default async function IntellectualPropertyPage(props: PageProps) {
  const params = await props.params;
      ...
      <div className="container mx-auto px-4 pt-8 pb-0 max-w-6xl text-left">
        ...
        <section id="ip-protection-needed" className="scroll-mt-24 mb-16">
          <h2 className="text-3xl font-bold mb-6 text-foreground border-b border-border/50 dark:border-white/10 pb-3">
            {getTranslation(contentData.ipTitle)}
          </h2>
          <p className="text-base text-muted-foreground leading-relaxed mb-6">
            {getTranslation(contentData.ipDesc)}
          </p>
          ...
          <div className="grid gap-6 md:grid-cols-2 mb-8">
            ...
            <div className="p-6 rounded-2xl border border-border/50 dark:border-white/15 bg-background/45 hover:border-primary/40 hover:bg-primary/5 transition-all duration-300 backdrop-blur-sm shadow-sm group">
              <h3 className="font-bold text-foreground group-hover:text-primary transition-colors text-lg mb-3 pb-1.5 border-b border-border/10">
                {getTranslation(contentData.reqTrademarkTitle)}
              </h3>
              <p className="text-sm text-muted-foreground leading-relaxed">
                {getTranslation(contentData.reqTrademarkDesc)}
              </p>
            </div>
            ...
            <div className="p-6 rounded-2xl border border-border/50 dark:border-white/15 bg-background/45 hover:border-primary/40 hover:bg-primary/5 transition-all duration-300 backdrop-blur-sm shadow-sm group">
              <h3 className="font-bold text-foreground group-hover:text-primary transition-colors text-lg mb-3 pb-1.5 border-b border-border/10">
                {getTranslation(contentData.reqManagementTitle)}
              </h3>
              <p className="text-sm text-muted-foreground leading-relaxed">
                {getTranslation(contentData.reqManagementDesc)}
              </p>
            </div>
            ...
            <div className="p-6 rounded-2xl border border-border/50 dark:border-white/15 bg-background/45 hover:border-primary/40 hover:bg-primary/5 transition-all duration-300 backdrop-blur-sm shadow-sm group">
              <h3 className="font-bold text-foreground group-hover:text-primary transition-colors text-lg mb-3 pb-1.5 border-b border-border/10">
                {getTranslation(contentData.reqCopyrightTitle)}
              </h3>
              <p className="text-sm text-muted-foreground leading-relaxed">
                {getTranslation(contentData.reqCopyrightDesc)}
              </p>
            </div>
            ...
            <div className="p-6 rounded-2xl border border-border/50 dark:border-white/15 bg-background/45 hover:border-primary/40 hover:bg-primary/5 transition-all duration-300 backdrop-blur-sm shadow-sm group">
              <h3 className="font-bold text-foreground group-hover:text-primary transition-colors text-lg mb-3 pb-1.5 border-b border-border/10">
                {getTranslation(contentData.reqDesignTitle)}
              </h3>
              <p className="text-sm text-muted-foreground leading-relaxed">
                {getTranslation(contentData.reqDesignDesc)}
              </p>
            </div>
          </div>
