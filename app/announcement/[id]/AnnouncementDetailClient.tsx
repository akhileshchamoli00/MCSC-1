...
export default function AnnouncementDetailClient({ id }: { id: string }) {
  ...
  const announcement = t.announcement.items.find((item: any) => item.id === id)
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <Card className="border-2 border-primary/20 bg-background/50 backdrop-blur-md shadow-2xl overflow-hidden rounded-2xl">
            <CardHeader className="pt-10 pb-6 px-8 md:px-12 border-b border-primary/10 text-center flex flex-col items-center">
              ...
              <h1 className="text-3xl md:text-5xl font-bold leading-tight tracking-tight text-foreground text-center">
                {announcement.title}
              </h1>
            </CardHeader>
